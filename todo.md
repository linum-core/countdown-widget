...
- [ ] Colocar propaganda no site de config
  ...
  - [ ] Colocar API key nas envs da vercel
    - [ ] Insira o URL do seu site e os seus dados de contato.
    - [ ] Copie o código de anúncio gerado pela plataforma.
    - [ ] Cole o código no cabeçalho (<head>) do código-fonte do seu site para validar a propriedade e começar a exibir os anúncios automáticos ou manuais
